...
const applications = {
    ...
    "Microsoft Teams": {
        ...
        icon: `./image/applications/microsoft_teams.svg`,
    ...
    "Microsoft Outlook": {
        ...
        icon: `./image/applications/microsoft_outlook.svg`,
    ...
    "Microsoft OneDrive": {
        ...
        icon: `./image/applications/microsoft_onedrive.svg`,
    ...
    "Microsoft Forms": {
        ...
        icon: `./image/applications/microsoft_forms.svg`,
    ...
    "Microsoft PowerPoint": {
        ...
        icon: `./image/applications/microsoft_powerpoint.svg`,
    ...
    "Microsoft Word": {
        ...
        icon: `./image/applications/microsoft_word.svg`,
    ...
    "Microsoft Excel": {
        ...
        icon: `./image/applications/microsoft_excel.svg`,
    ...
    "Microsoft SharePoint": {
        ...
        category: 'Application',
        description: `SharePoint Online, while available on Office 365, is a collaborative platform that integrates with Microsoft Office. SharePoint Online, which can be configured for a company's usage, allows an enterprise to store, retrieve, search, archive, track, manage, and report on digitized documents.<br><br>At CareerSource Central Florida, we use SharePoint Online to host our company intranet, The Source. Also, SharePoint is the online platform where your Teams group documents can exist, in the form of a "SharePoint Site".`,
        icon: `./image/applications/microsoft_sharepoint.svg`,
        logo: `./image/applications/logos/microsoft_sharepoint_logo.png`,
        colors: ['#007133', '#fff'],
        keywords: ['spreadsheet', '.xlsx', '.csv', 'data', 'workbook', 'excell', 'excelll'],
